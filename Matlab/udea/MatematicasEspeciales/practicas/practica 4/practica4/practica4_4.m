function practica4_4
uicontrol('style','text','position',[140 250 90 55],'string','Ingrese la función h(z):','fonts',12);
...
%uicontrol('style','text','position',[438 230 10 20],'string','ó','fonts',12)
            ...
            case 1
                ...
                if n == length(raices)
                    ...
                    if k1 > length(raices)
                        ...
                        f2=vpolos;
                        p=length(raices)-1;
                        for i=1:length(raices)-2
                            p=p*(length(raices)-1-i)
                        end
                        integral=(2*pi*1i*(1/p)*subs(diff(fz,z,length(raices)),z,f2))
