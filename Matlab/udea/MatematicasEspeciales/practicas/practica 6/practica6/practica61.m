function practica61
uicontrol('style','text','position',[20 385 500 40],'string','Simulación series de Fourier de la función F(t)','fonts',17);
uicontrol('style','text','position',[10 350 400 25],'string','Ingrese los intervalos de los tramos :','fonts',15);
uicontrol('style','text','position',[10 300 350 25],'string','Ingrese las funciones (Tramos):','fonts',15);
uicontrol('style','pushbutton','position',[210 240 140 40],'string','Graficar ','FontSize',12,'callback',@boton_1);
%uicontrol('style','pushbutton','position',[390 210 140 40],'callback',@boton_1,'string','Ingresar intervalos ','FontSize',12);
intervalo=uicontrol('style','edit','position',[380 345 150 20],'fonts',12);
...
funcione=uicontrol('style','edit','position',[325 300 150 20]);
