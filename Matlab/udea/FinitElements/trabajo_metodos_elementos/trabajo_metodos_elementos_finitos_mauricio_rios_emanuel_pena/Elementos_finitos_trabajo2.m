function Elementos_finitos_trabajo2 
clear all
close all
clc
...
hii=xii^2-xi^2; % Ingresar las funciones de forma para la utilización de la FEA.
H1=(xii^2-x^2)/hii;
H2 = (x^2-xi^2)/hii;
...
n=50; % Número de divisiones del dominio, este se variará para ver la influencia de este parámetro
