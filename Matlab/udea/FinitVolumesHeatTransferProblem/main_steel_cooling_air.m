...
%Generamos tabla con taos maximos para cada tipo de nodo y tiempos máximos:
 ...
 T=ones(45,37,1);
 T=5.*T; % Se llenan los nodos, con una temperatura igual al de los gases
...
% representación gráfica))
    ...
    title('Distribución de Temperaturas (enfriamiento)');
 ...
 % del while, el criterio de parada se definirá proximamente:
   ...
   for m=2:44
       for n=34:36
           T(m,n,ts)=T(m,n,ts-1)*(1-4*tao(1))+tao(1)*(T(m-1,n,ts-1)+T(m+1,n,ts-1)+T(m,n-1,ts-1)+T(m,n+1,ts-1));
       end
   end
   ...
   for m=1:1
       for n=20:20
          T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(((2*h*Deltaw)/k(1))+4))+tao(1)*(2*T(m+1,n,ts-1)+T(m,n-1,ts-1)+T(m,n+1,ts-1)+(2*h*Deltaw/k(1))*T_inf);
   ...
   for m=2:44
       for n=37:37
           T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(((2*h*Deltaw)/k(1))+4))+tao(1)*(2*T(m,n-1,ts-1)+T(m-1,n,ts-1)+T(m+1,n,ts-1)+(2*h*Deltaw/k(1))*T_inf);
       end
   end
   ...
   for m=1:1
       for n=37:37
           T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(((4*h*Deltaw)/k(1))+4))+tao(1)*(2*T(m,n-1,ts-1)+2*T(m+1,n,ts-1)+(4*h*Deltaw/k(1))*T_inf);
       end
   end
   ...
   for m=45:45
       for n=37:37
           T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(((4*h*Deltaw)/k(1))+4))+tao(1)*(2*T(m-1,n,ts-1)+2*T(m,n-1,ts-1)+(4*h*Deltaw/k(1))*T_inf);
       end
   end
   ...
   for m=9:9
       for n=33:33
            T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(4)*(((h*Deltaw)/(3*k(1)))+1))+tao(1)*(2/3)*(T(m-1,n,ts-1)+2*T(m+1,n,ts-1)+T(m,n-1,ts-1)+2*T(m,n+1,ts-1)+(2*h*Deltaw/k(1))*T_inf);
       end
   end
   ...
   for m=13:13
       for n=33:33
             T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(4)*(((h*Deltaw)/(3*k(1)))+1))+tao(1)*(2/3)*(2*T(m-1,n,ts-1)+T(m+1,n,ts-1)+T(m,n-1,ts-1)+2*T(m,n+1,ts-1)+(2*h*Deltaw/k(1))*T_inf);
       end
   end
   ...
   for m=9:9
       for n=21:21
            T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(4)*(((h*Deltaw)/(3*k(1)))+1))+tao(1)*(2/3)*(T(m-1,n,ts-1)+2*T(m+1,n,ts-1)+2*T(m,n-1,ts-1)+T(m,n+1,ts-1)+(2*h*Deltaw/k(1))*T_inf);
       end
   end
   ...
   for m=13:13
       for n=21:21
            T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(4)*(((h*Deltaw)/(3*k(1)))+1))+tao(1)*(2/3)*(2*T(m-1,n,ts-1)+T(m+1,n,ts-1)+2*T(m,n-1,ts-1)+T(m,n+1,ts-1)+(2*h*Deltaw/k(1))*T_inf);
       end
   end
   ...
   for m=2:44
       for n=19:19
           T(m,n,ts)=T(m,n,ts-1)*(1-4*tao(1))+tao(1)*(2*T(m,n+1,ts-1)+T(m-1,n,ts-1)+T(m+1,n,ts-1));
       end
   end
   ...
   for m=1:1
       for n=19:19
            T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(((2*h*Deltaw)/k(1))+4))+tao(1)*2*(T(m,n+1,ts-1)+T(m+1,n,ts-1)+(h*Deltaw/k(1))*T_inf);
       end
   end
   ...
   for m=45:45
       for n=19:19
            T(m,n,ts)=T(m,n,ts-1)*(1-tao(1)*(((2*h*Deltaw)/k(1))+4))+tao(1)*2*(T(m-1,n,ts-1)+T(m,n+1,ts-1)+(h*Deltaw/k(1))*T_inf);
       end
   end
   ...
   title('Temperatura promedio vs tiempo (AISI 1010 en aire, enfriamiento)');
